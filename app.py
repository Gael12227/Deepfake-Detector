...
import os
import tempfile             #Provides interfaces for creating temporary files and dirs
import torch
...
with col1:
    ...
    uploaded_file = st.file_uploader(
        "Video Upload Label", label_visibility="collapsed", type=["mp4", "avi", "mov"]
    )
...
st.write("A deepfake detection project by Abburu Gayatri Sree using face-based CNN+GNN classification with MTCNN .")